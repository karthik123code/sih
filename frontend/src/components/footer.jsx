...
const footer = () => {
  return (
              ...
              <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="410" font-weight="bold">
                      <tspan x="654" y="518">Parallax Minds</tspan>
                    </text>
                  </g>
                </g>
              </svg>
    ...
    <div class="bg-indigo-950 py-4 text-gray-100">
